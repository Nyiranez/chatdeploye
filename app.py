...
#nltk.download('punkt')
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://admin:HGlUX27HDdP79GFNfxd95sa0XZrTwQQX@dpg-cf39ba82i3mnjchpvbdg-a.oregon-postgres.render.com/chatbot_ercf"
db = SQLAlchemy(app)
CORS(app)
## Database
